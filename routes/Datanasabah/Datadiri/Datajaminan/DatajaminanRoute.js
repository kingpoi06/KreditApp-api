...
import { uploadJaminan } from "../../../../middleware/multerConfig.js";
...
router.post("/datanasabah/data-jaminan", officerOnly, uploadJaminan.fields([
    { name: "dokumentasiAgunan", maxCount: 1 },
  ]), createDataJaminan);
router.patch("/datanasabah/data-jaminan/:no_permohonan(.+)", updateOnly, uploadJaminan.fields([
    { name: "dokumentasiAgunan", maxCount: 1 },
  ]),updateDataJaminan);
