...
router.get("/datanasabah/data-analisis/:no_permohonan(.+)", getAllOnly, getAnalisisByNoPermohonan);
router.post("/datanasabah/data-analisis", getAllOnly, upload.none(), createAnalisis);
router.patch("/datanasabah/data-analisis/:no_permohonan(.+)", updateOnly, upload.none(), updateAnalisis);
router.delete("/datanasabah/data-analisis/:no_permohonan(.+)", superadminOnly, deleteAnalisis);
